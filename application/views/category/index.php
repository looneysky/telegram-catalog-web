...
$groups = getGroupsByCategory($name, $start_index, $end_index);

?>
<? require_once 'application/views/category/tags.php' ?>
<div id="content">
...
"><? echo $group['category'] ?></a></div>
                    ...
                    <div class="tg-pager-wrapper">
                        <ul class="tg-pager">
                        <?php for ($i = 1; $i <= ceil(countCategoriesBySearch($name) / $groups_per_page); $i++) { ?>
